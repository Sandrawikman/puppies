...
@Repository
public class LitterRepositoryImpl implements LitterRepository {

    private DataSource dataSource;

    @Autowired
    public LitterRepositoryImpl(@Qualifier("dataSource") DataSource dataSource) {
    ...
    public Litter createLitter(int userId, String name, Date dateOfBirth) {
        try (Connection conn = dataSource.getConnection();
             PreparedStatement ps = conn.prepareStatement("INSERT INTO litter(LitterName, Birthday, idUser) " +
            ...
            return new Litter(litterId, name, dateOfBirth);
    ...
    @Override
    public Litter createLitter(int userId, String name, java.util.Date dateOfBirth) {
        return null;
    }
    ...
    @Override
    public void updateLitter(int litterId, int userId, String name, java.util.Date dateOfBirth) {
